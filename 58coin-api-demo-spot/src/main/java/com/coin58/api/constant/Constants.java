package com.coin58.api.constant;
...
public class Constants {
    ...
    public static final String X_58COIN_APIKEY = "X-58COIN-APIKEY";
    public static final String X_58COIN_SIGNATURE = "X-58COIN-SIGNATURE";